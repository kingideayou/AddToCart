	...
	private class ProductAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				holder.img = (ImageView) convertView.findViewById(R.id.im);
			...
			holder.img.setImageResource(R.drawable.chi2);
			//购买按钮的点击事件监听
...
//		translateAnimationY.setInterpolator(new AccelerateInterpolator());
		translateAnimationY.setInterpolator(new CustomInterpolator());
